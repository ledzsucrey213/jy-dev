...
const Services = () => {
  ...
  const content = {
    fr: {
      ...
      service1Price: "Sites web à partir de <strong>600€</strong>",
      ...
      service2Price: "Applications mobiles à partir de <strong>1000€</strong>",
    },
    en: {
      title: "Our Services",
      ...
      service1Price: "Websites starting at just <strong>€600</strong>",
      ...
      service2Price: "Mobile apps available from <strong>€1000</strong>",
    },
  };
